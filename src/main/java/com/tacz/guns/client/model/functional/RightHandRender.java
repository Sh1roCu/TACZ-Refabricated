    ...
    public void render(PoseStack poseStack, VertexConsumer vertexBuffer, ItemDisplayContext transformType, int light, int overlay) {
        if (transformType.firstPerson()) {
            ...
            bedrockGunModel.delegateRender((poseStack1, vertexBuffer1, transformType1, light1, overlay1) -> {
                ...
                RenderHelper.renderFirstPersonArm(viewPlayer instanceof net.minecraft.client.player.LocalPlayer lp ? lp : Minecraft.getInstance().player, HumanoidArm.RIGHT, poseStack2, light1);
